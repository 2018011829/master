...
/**
 * Servlet implementation class AttentionMoments
 */
@WebServlet("/AttentionMomentsService")
public class AttentionMomentsService extends HttpServlet {
	 ...
	 */
	public AttentionMomentsService() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String json0 = gson.toJson(momentList);
