            ...
            <div id="menu">
                <ul class="menu">
                    ...
                    <li id="idiom" onclick="showIdiomMenu()">
                        <a href="idiomInfo.jsp">成语信息管理</a><img src="imgs-server/home/xiala.png" id="xiala2">
                    </li>
                    <ul class="idiom_menu" id="click_idiom_menu" style="display: block">
                        <li onclick="showMenu_type2()" id="idiom_type" style="background: #009688"><a href="idiomType.jsp">成语分类</a></li>
