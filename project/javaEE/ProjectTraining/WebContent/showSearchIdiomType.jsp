				...
				<div style="width: 1100px; text-align: center; margin-bottom: 20px">
					...
					<div style="margin-top: 30px">
						总共有${page.totalPageNum }页，总共有${page.totalCount }个数据； <a
							href="SearchIdiomTypeServlet?page=1&userName=${userName }&searchInfo=${searchInfo }"
							style="color: black">首页</a> <a
							href="SearchIdiomTypeServlet?page=${page.prePageNum }&userName=${userName }&searchInfo=${searchInfo }"
							style="color: black">上一页</a> <a
							href="SearchIdiomTypeServlet?page=${page.nextPageNum }&userName=${userName }&searchInfo=${searchInfo }"
							style="color: black">下一页</a> <a
							href="SearchIdiomTypeServlet?page=${page.totalPageNum }&userName=${userName }&searchInfo=${searchInfo }"
