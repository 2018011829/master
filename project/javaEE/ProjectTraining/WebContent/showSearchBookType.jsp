		...
		<div id="index_home">
			...
			<div id="info" style="height:550px;">
				...
				<div style="height:40px;line-height:40px;margin-bottom:20px">
				    <form action="SearchBookTypeServlet">
				...
				<div style="width:1100px;text-align:center;margin-bottom:20px">
	                ...
	                <div style="margin-top:30px">总共有${page.totalPageNum }页，总共有${page.totalCount }个数据；
	                    <a href="SearchBookTypeServlet?page=1&userName=${userName }&searchInfo=${searchInfo }" style="color: black">首页</a>
	                    <a href="SearchBookTypeServlet?page=${page.prePageNum }&userName=${userName }&searchInfo=${searchInfo }" style="color: black">上一页</a>
	                    <a href="SearchBookTypeServlet?page=${page.nextPageNum }&userName=${userName }&searchInfo=${searchInfo }" style="color: black">下一页</a>
	                    <a href="SearchBookTypeServlet?page=${page.totalPageNum }&userName=${userName }&searchInfo=${searchInfo }" style="color: black">末页</a>
	                </div>
				</div>
