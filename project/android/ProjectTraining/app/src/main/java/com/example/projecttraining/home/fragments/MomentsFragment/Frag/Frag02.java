...
import com.example.projecttraining.home.fragments.MomentsFragment.Adapter.Frag02Adapter;
...
public class Frag02 extends Fragment {
    ...
    private List<Moments> moments = new ArrayList<>();//说说列表
                ...
                switch (msg.what){
                    case 3:
                        ...
                        if(!json.equals("")){
                            ...
                            initView(moments,view);//准备adapter
                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 添加布局文件
        View view=inflater.inflate(R.layout.fragment_moments_frag02, container, false);
    ...
    private void initView(List<Moments> moments, View view) {
        frag02Adapter = new Frag02Adapter(getContext(), moments, R.layout.fragment_moments_frag02_item);
        momentsListView = view.findViewById(R.id.lv_moments_list);
        momentsListView.setAdapter(frag02Adapter);
    }
}
