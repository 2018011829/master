...
public class CommentExpandAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpand, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.fragment_moments_frag01_item_comment_item, viewGroup, false);
        ...
        Glide.with(context)
                .load(commentBeanList.get(groupPosition).getUserLogo())
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.fragment_moments_frag01_item_comment_reply_item,viewGroup, false);
        ...
        String replyUser = commentBeanList.get(groupPosition).getReplyList().get(childPosition).getPersonName();
        ...
        childHolder.tv_content.setText(commentBeanList.get(groupPosition).getReplyList().get(childPosition).getReplyContent());
