package com.example.practicaltraining.login;
...
import com.example.practicaltraining.MainActivity;
import com.example.practicaltraining.R;
import com.example.practicaltraining.register.RegisterActivity;
import com.example.practicaltraining.util.ConfigUtil;
...
public class LoginByPasswordActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what){
                case 1://获得密码登录的请求结果
                    ...
                    if (response.equals("success")){//登录成功 跳转到首页
    ...
    private void checkPhoneNumAndPwd() {
        ...
        Request request=new Request.Builder()
                .post(body)
                .url(ConfigUtil.SERVICE_ADDRESS+"检测登录的servlet")
                .build();
        //获得call对象
